...
<body>
	...
	<div class="container">
		<div class="card w-50 mx-auto my-5">
			<div class="card-header text-center">Supplier Add</div>
			<div class="card-body">
				<div class="form-group">
					<label>Supplier Name</label> <input type=text id="suppName"
						required class="form-control" placeholder="Enter supplier Name">
				</div>
				<div class="form-group">
					<label>Supplier City</label> <input type=text id="suppCity"
						required class="form-control" placeholder="Enter supplier City">
				</div>
				<div class="form-group">
					<label>Supplier Phone</label> <input type=text id="suppPhone"
						required class="form-control" placeholder="Enter supplier Phone">
				</div>
	...
	<div id="displayDiv" style="display: none">
		<h3>Supplier ADDED Successfully to database</h3>
	...
	jQuery(document).ready(function($) {
		...
		$("#submit").click(function(){
			var supplierData = {};
			supplierData["id"] = $("#id").val();
			supplierData["suppName"] = $("#suppName").val();
			supplierData["suppCity"] = $("#suppCity").val();
			supplierData["suppPhone"] = $("#suppPhone").val();	
			$.ajax({
				type : "POST",

			...
			<div class="card w-50 mx-auto my-5">
				...
				<div class="card-body">
					<div class="form-group">
						<label>Product Name</label> <input type=text id="proName"
							name="proName" required class="form-control"
							placeholder="Enter product Name">
					</div>
					<div class="form-group">
						<label>Product Description</label> <input type=text id="proDesc"
							name="proDesc" required class="form-control"
					...
					<div class="text-center">
						<input type="submit" id="submit"
							class="btn btn-lg btn-primary btn-block" value="Create" />
					</div>
	...
	<script>
		jQuery(document).ready(function($) {
			...
			$("#submit").click(function() {
				...
				productData["proName"] = $("#proName").val();
				productData["proDesc"] = $("#proDesc").val();

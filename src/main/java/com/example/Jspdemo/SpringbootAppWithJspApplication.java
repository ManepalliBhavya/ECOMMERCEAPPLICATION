...
import com.example.Jspdemo.controller.ProductController;
import com.example.Jspdemo.model.Role;
import com.example.Jspdemo.repository.RoleRepository;

/**
 * same as @Configuration @EnableAutoConfiguration @ComponentScan. 
 * 
 * This annotation is responsible for setting up which autoconfiguration to enable
 * and where to look for spring bean components and configurations.
 */
@SpringBootApplication

public class SpringbootAppWithJspApplication {
	/**
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(SpringbootAppWithJspApplication.class, args);

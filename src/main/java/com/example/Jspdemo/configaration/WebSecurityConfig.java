package com.example.Jspdemo.configaration;
 ...
 * enable Spring Web Security and extends Spring Security `WebSecurityConfigurerAdapter`, 
 */
@Configuration
@EnableWebSecurity
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/").permitAll()
				...
				.antMatchers("/photos/add").permitAll()
				.antMatchers("/productshop").permitAll()
				.antMatchers("/photos/{id}").permitAll()
				.antMatchers("/photos/photopage").permitAll()
				...
				.antMatchers("productDetails").hasAnyAuthority("ADMIN", "USER")
